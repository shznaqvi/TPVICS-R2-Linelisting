...
import static edu.aku.hassannaqvi.tpvicsround2listing.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.tpvicsround2listing.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.tpvicsround2listing.models.SyncModel;
import edu.aku.hassannaqvi.tpvicsround2listing.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.tpvicsround2listing.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.tpvicsround2listing.workers.PhotoUploadWorker2;
import edu.aku.hassannaqvi.tpvicsround2listing.workers.ReadJSONWorker;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSync:
                ...
                downloadTables.add(new SyncModel(ClusterTable.TABLE_NAME));
